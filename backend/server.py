...
def retrieve_context(query, top_k=5):
    ...
    keyword_map = {
        'admission': 'tuyển sinh xét tuyển nhập học',
        'admissions': 'tuyển sinh xét tuyển nhập học',
        'enroll': 'tuyển sinh xét tuyển nhập học',
        'enrollment': 'tuyển sinh xét tuyển nhập học',
        'apply': 'đăng ký ứng tuyển nộp hồ sơ',
        'application': 'hồ sơ đăng ký',
        'requirement': 'điều kiện yêu cầu đầu vào',
        'requirements': 'điều kiện yêu cầu đầu vào',
        'score': 'điểm chuẩn xét tuyển',
        'scores': 'điểm chuẩn xét tuyển',
        'grade': 'điểm chuẩn học bạ',
        'grades': 'điểm chuẩn học bạ',
        ...
        'cost': 'chi phí học phí',
        'financial': 'tài chính',
        'pay': 'thanh toán đóng tiền',
        'payment': 'thanh toán đóng tiền',
        
        # Academics
        'major': 'ngành chuyên ngành đào tạo',
        'majors': 'ngành chuyên ngành đào tạo',
        ...
        'subject': 'môn học',
        'study': 'học tập',
        'degree': 'bằng cấp cử nhân',
        'bachelor': 'cử nhân',
        
        # Faculty
        'faculty': 'giảng viên chuyên gia tiến sĩ thạc sĩ giáo sư ts ths',
        'teacher': 'giảng viên thầy cô',
        'teachers': 'giảng viên thầy cô',
        'lecturer': 'giảng viên',
        'lecturers': 'giảng viên',
        'professor': 'giáo sư tiến sĩ gs ts',
        
        # Facilities / Location
        'campus': 'cơ sở địa chỉ',
        'location': 'cơ sở địa chỉ nằm ở đâu',
        'address': 'cơ sở địa chỉ',
        'where': 'cơ sở địa chỉ nằm ở đâu',
        'located': 'cơ sở địa chỉ nằm ở đâu',
        'dormitory': 'ký túc xá',
        'dorm': 'ký túc xá',
